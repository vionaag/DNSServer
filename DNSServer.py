...
# IMPORTANT: just cast to string — the DNS TXT type requires text.
# Do not alter padding, no quotes, no decoding logic — simply str()
...
dns_records = {
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (token_text,),  # plain text cast of encrypted data
        ...
        try:
            ...
            if qname in dns_records and qtype in dns_records[qname]:
                ...
                if qtype == dns.rdatatype.MX:
                    ...
                    rdata = SOA(dns.rdataclass.IN, dns.rdatatype.SOA, mname, rname, serial,
